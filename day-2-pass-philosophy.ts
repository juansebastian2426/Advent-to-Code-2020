...
for (let data of input) {
  ...
  for (var i = 0; i < password.length; i++) {
    if (password[i].toLowerCase() === letter) {
      numberTimesRepeated.push(i);
    }
  }

  if (numberTimesRepeated.length >= minQuantity && numberTimesRepeated.length <= maxQuantity) {
...
//   if ('pncmjxlvckfbtrjh'[i].toLowerCase() === 't') {
//     numberTimesRepeated.push(i);
//   }
// }
// console.log(numberTimesRepeated.length);